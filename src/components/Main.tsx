...
const Main = () => {
    return (
        <motion.div className='sm:pt-[10%] sm:px-10 pt-[25%] p-5 xl:flex justify-between gap-20'
            ...
            >
            <div className=''>
                <motion.h1 className='sm:text-[70px] text-[55px] pt-10 font-bold'>Your Partner for <br className='sm:flex hidden' /> every <span className='font-light'>tech </span>activities.</motion.h1>
